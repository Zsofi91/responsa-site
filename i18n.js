...
const STRINGS = {
  en: {
    ...
    "how.s4.p": "By default every reply comes to you on Telegram and goes out when you tap approve. If you'd rather not see all of them, tell us which replies can publish on their own.",
    ...
    "addon.s2.p": "Every post comes to you on Telegram. One tap approves it — nothing goes out until you say so.",
    ...
    "price.add.f2": "Approve on Telegram",
    ...
    "ginsta.s3.h": "You approve everything on Telegram",
    "ginsta.s3.p": "Every post and story arrives as a preview on Telegram. One tap approves it — and you can ask for a change, or a new post, anytime.",
    ...
    "priv.what.s1.i1": "Your name, email address and phone number",
    ...
    "priv.what.p1": "We don't use tracking cookies, and there are no advertising trackers on this site. We measure traffic with Cloudflare's cookieless web analytics — page views, country, browser, operating system and device type, referring page, page load speed. It doesn't identify individuals. Our forms are embedded from Tally, which sets what it needs to work.",
    ...
    "priv.why.i4": "<strong>To see how many people visit the site</strong> — aggregated visit statistics that identify no one. Legal basis: legitimate interest in knowing whether the website works.",
    ...
    "priv.insta.intro": "We're working on an Instagram add-on that isn't available yet. It will only apply to customers who separately connect it later — and only from the moment they connect it. Here's what it will mean for your data.",
    "priv.insta.photos.h": "Photos and labelling",
    "priv.insta.photos.i1": "You share a photo folder with us on Google Drive — we send the exact address at registration; Viewer access is enough, and you can unshare it anytime.",
    "priv.insta.photos.i2": "An AI model (Google Gemini) reviews the photos and labels what's in them, so posts can be built from the right images.",
    "priv.insta.photos.i3": "We store the labels and a copy of each photo for as long as you're a customer — after that we delete them.",
    "priv.insta.publish.h": "Publishing and approval",
    "priv.insta.publish.i1": "Every post and story is sent to you as a preview on Telegram, and you approve it with one tap. Nothing goes out without you.",
    "priv.insta.publish.i2": "Approved posts are published through the official Instagram (Meta) API to your connected professional account. We keep a journal of what was published and when.",
    "priv.insta.ok.h": "In short:",
    "priv.insta.ok.p": " we never ask for your password, and we don't sell your photos or use them for advertising. You can stop anytime: unshare the folder and disconnect Instagram — posts already published stay yours.",
    ...
    "priv.ret.i6": "<strong>Visit statistics:</strong> stored by Cloudflare in aggregated form that identifies no one, available for the previous six months.",
